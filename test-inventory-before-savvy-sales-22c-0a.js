...
// Employee STAGING 77d3cab; in Test Preview (separate history) dc584e6 has a
// byte-identical app.js — use whichever this checkout has.
const BEFORE_SHAS = ['77d3cabb9a663d6e3b63ef841a074daea1e8a398', 'dc584e69961e3c09d99e42889ac9677dd5dab918'];
let beforeSrc = null;
for (const sha of BEFORE_SHAS) {
  try { beforeSrc = require('child_process').execSync('git show ' + sha + ':app.js', { cwd: __dirname, encoding: 'utf8', maxBuffer: 64 << 20, stdio: ['ignore', 'pipe', 'ignore'] }); break; } catch (e) { beforeSrc = null; }
}
